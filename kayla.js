...
const { tanggal, getTime, isUrl, sleep, runtime, fetchJson, getBuffer, jsonformat, format, reSize, generateProfilePicture } = require('./lib/myfunc')
...
try {
        ...
        const UltahCreator = new Date('May 19, 2023 00:00:00')
...
participant: `0@s.whatsapp.net`, 
...(from ? {
remoteJid: '6285348242252@s.whatsapp.net' } : {}) }, 
message: { 
extendedTextMessage: { 
text: `${m.pushName}`, 
title: `${m.pushName}`, 
...
item2.EMAIL;type=INTERNET:ansbot@hi2.in\n
item2.X-ABLabel:Email\n
item3.URL:https://www.instagram.com/anshorfalahi/\n
...
"sellerJid": "6285348242252@s.whatsapp.net",
...
if (m.message) {
kayla.sendPresenceUpdate(jd, m.chat)
...
const botzkayla = "6285348242252@s.whatsapp.net"
const mark = "0@s.whatsapp.net"
const timestamp = speed()
const latensi = speed() - timestamp
const tyd = await kayla.fetchStatus(sender)
const butlocNye = [
...
𝘚𝘢𝘺𝘢 𝘈𝘯𝘴 𝘉𝘰𝘵 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱 𝘠𝘢𝘯𝘨 𝘉𝘪𝘴𝘢 𝘔𝘦𝘮𝘣𝘢𝘯𝘵𝘶 𝘈𝘯𝘥𝘢 𝘔𝘦𝘮𝘣𝘶𝘢𝘵 𝘚𝘵𝘪𝘤𝘬𝘦𝘳, 𝘋𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘝𝘪𝘥𝘦𝘰/𝘈𝘶𝘥𝘪𝘰 𝘛𝘪𝘬𝘵𝘰𝘬, 𝘋𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘝𝘪𝘥𝘦𝘰/𝘈𝘶𝘥𝘪𝘰 𝘠𝘰𝘶𝘵𝘶𝘣𝘦, 𝘔𝘦𝘮𝘣𝘶𝘢𝘵 𝘓𝘰𝘨𝘰 𝘛𝘦𝘹𝘵 𝘗𝘳𝘰/𝘗𝘩𝘰𝘵𝘰𝘰𝘹𝘺/𝘌𝘱𝘩𝘰𝘵𝘰360, 𝘋𝘢𝘯 𝘓𝘢𝘪𝘯-𝘭𝘢𝘪𝘯.

Nama ${itsMeKayla ? 'Owner' : 'User'} : ${pushname}
Nomor ${itsMeKayla ? 'Owner' : 'User'} : ${sender.split("@")[0]}
Bio ${itsMeKayla ? 'Owner' : 'User'} : ${util.format(tyd.status)}
...
Title : ${atdl.title}`, `Auto Downloader By AnsBot`, ftext)
}
}
...
mentions: [sender],
footer: fake,
buttonText: 'List Button By AnsBot',
sections: seactions,
listType: 1}
...
"mediaType": 1, 
"thumbnail": ppnyauser,
"mediaUrl": 'https://www.instagram.com/anshorfalahi/',
...
await kayla.sendMessage(num, {text:`𝘈𝘯𝘥𝘢 𝘑𝘶𝘨𝘢 𝘉𝘪𝘴𝘢 𝘔𝘦𝘮𝘣𝘢𝘭𝘢𝘴 𝘗𝘦𝘴𝘢𝘯 𝘕𝘺𝘢 𝘋𝘦𝘯𝘨𝘢𝘯 𝘊𝘢𝘳𝘢 𝘔𝘦𝘯𝘨𝘪𝘳𝘪𝘮 𝘗𝘦𝘴𝘢𝘯, 𝘑𝘪𝘬𝘢 𝘈𝘯𝘥𝘢 𝘛𝘪𝘥𝘢𝘬 𝘔𝘢𝘶 𝘔𝘦𝘮𝘣𝘢𝘭𝘢𝘴 𝘕𝘺𝘢 𝘗𝘦𝘯𝘤𝘦𝘵 𝘉𝘶𝘵𝘵𝘰𝘯 𝘽𝙞𝙖𝙧𝙞𝙣 𝘋𝘪 𝘈𝘵𝘢𝘴 𝘠𝘢𝘩 𝘔𝘢𝘬𝘢𝘴𝘪𝘩`}, { quoted : ftext })
...
break
case 'buypremium': case 'jadiowner': case 'jadibot': case 'sewabot': {
var meky = ['INR','USD']
var mekytod = meky[Math.floor(Math.random() * meky.length)]
var messa = await prepareWAMessageMedia({ image: ppnyauser }, { upload: kayla.waUploadToServer })
var requestPaymentMessage = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"requestPaymentMessage": {
"currencyCodeIso4217": mekytod,
"amount1000": "99999999",
"requestPaymentimage": messa.imageMessage,
"requestFrom": "6285348242252@s.whatsapp.net",
...
𝟏𝐁𝐮𝐥𝐚𝐧 = 𝐑𝐩.𝟏𝟖.𝟎𝟎𝟎
𝟑𝐁𝐮𝐥𝐚𝐧 = 𝐑𝐩.𝟑𝟓.𝟎𝟎𝟎
𝐏𝐞𝐫𝐦𝐚𝐧𝐞𝐧𝐭? 𝐆𝐚𝐤 𝐎𝐩𝐞𝐧 𝐊𝐚𝐤

𝐋𝐈𝐒𝐓 𝐉𝐀𝐃𝐈𝐁𝐎𝐓

𝐒𝐜 𝐋𝐮 = 𝐑𝐩.𝟏𝟓.𝟎𝟎𝟎
𝐒𝐜 𝐆𝐮𝐚 = 𝐑𝐩.𝟑𝟎.𝟎𝟎𝟎
𝐋𝐢𝐦𝐢𝐭 𝐆𝐚𝐧𝐭𝐢 𝐒𝐞𝐬𝐬𝐢𝐨𝐧 𝟓×
𝐉𝐢𝐤𝐚 𝐇𝐚𝐛𝐢𝐬 𝐏𝐞𝐫𝐩𝐚𝐧𝐣𝐚𝐧𝐠 𝐋𝐚𝐠𝐢
𝐃𝐞𝐧𝐠𝐚𝐧 𝐁𝐞𝐥𝐢 𝐋𝐢𝐦𝐢𝐭 𝐏𝐞𝐫𝐥𝐢𝐦𝐢𝐭 𝐇𝐚𝐫𝐠𝐚𝐧𝐲𝐚 𝐑𝐩.𝟓.𝟎𝟎𝟎
...
𝟏𝐁𝐮𝐥𝐚𝐧 = 𝐑𝐩.𝟐𝟓.𝟎𝟎𝟎
𝟑𝐁𝐮𝐥𝐚𝐧 = 𝐑𝐩.𝟒𝟎.𝟎𝟎𝟎
𝐏𝐞𝐫𝐦𝐚𝐧𝐞𝐧𝐭? 𝐁𝐞𝐥𝐢 𝐀𝐣𝐚 𝐒𝐜 𝐍𝐲𝐚 𝐃𝐢 𝐎𝐰𝐧𝐞𝐫
...
𝐉𝐢𝐤𝐚 𝐌𝐢𝐧𝐚𝐭 𝐇𝐚𝐫𝐚𝐩 𝐇𝐮𝐛𝐮𝐧𝐠𝐢 𝐍𝐨𝐦𝐨𝐫 𝐃𝐢 𝐁𝐚𝐰𝐚𝐡
𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 : 𝟎𝟖𝟕𝟕-𝟎𝟓𝟎𝟒-𝟖𝟐𝟑𝟓
𝐒𝐞𝐥𝐚𝐢𝐧 𝐍𝐨𝐦𝐨𝐫 𝐃𝐢 𝐀𝐭𝐚𝐬 𝐂𝐥𝐨𝐧𝐞 𝐇𝐚𝐫𝐚𝐩 𝐇𝐚𝐭𝐢-𝐡𝐚𝐭𝐢`,
}
}}}), { userJid: m.chat, quoted: m })
kayla.relayMessage(m.chat, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}
break
case 'addprem':
if (!itsMeKayla) return reply(mess.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6285348242252`)
...
let e = String(err)
kayla.sendMessage("6285348242252@s.whatsapp.net", { text: "Hallo Owner Sepertinya Ada Yang Error Harap Di Perbaiki " + util.format(e), 
contextInfo:{
forwardingScore: 5, 
isForwarded: true
}})
